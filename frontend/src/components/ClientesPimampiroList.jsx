...
export const ClientesPimampiroList = () => {
  ...
  return (
    <div className="container">
      <div className="mb-3" >
      <h3 style={{ color: '#3c6d79', textAlign: 'center', paddingTop: '50px' }}>Clientes Pimampiro</h3>
      <div className="row">
          <div className="col text-end">
            <Link
              to="/crear-clientePimampiro"
            ...
            <tr key={cliente.cedula} className={determinarClasesFila(cliente)}>
              ...
              <td>
                <button className="btn" role="button" style={linkStyles}>
                  <Link to={`/clientesPimampiro/${cliente.id}/PagosMensualesPimampiro`}>
                    <i className="bi bi-file-earmark-person-fill" style={{ color: '#3c6d79' }}></i>
                  </Link>
                </button>
                <button
                  className="btn" role="button" style={linkStyle}
                  onClick={() => navigate(`/clientesPimampiro/${cliente.id}`)} >
