...
import { getCliente } from "../api/clientesAngel.api";
import { getAllPagos } from "../api/generarPagoAngel.api";
import { getAllProductos } from "../api/productos.api";

export const PagosMensualesAngel = () => {
  const { id } = useParams();
  ...
  const handleGenerarPagoClick = () => {
    navigate(`/clientesAngel/${id}/generarPagoAngel`, {
      state: {
  ...
  return (
    <div className="container">
      <Link to="/clienteAngel" className=" mt-1 btn btn-dark btn-lg">
      ...
      <button
        ...
        role="button"
        style={linkStyle}
        onClick={() => navigate(`/clientesAngel/${cliente.id}`)}
      >
