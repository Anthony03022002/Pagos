...
export const ClientesAtuntaquiList = () => {
  ...
  return (
    <div className="container">
      <div className="mb-3" >
      <h3 style={{ color: '#3c6d79', textAlign: 'center', paddingTop: '50px' }}>Clientes Atuntaqui</h3>
      <div className="row">
          <div className="col text-end">
            <Link
              to="/crear-clienteAtuntaqui"
            ...
            <tr key={cliente.cedula} className={determinarClasesFila(cliente)}>
              ...
              <td>
                <button className="btn" role="button" style={linkStyles}>
                  <Link to={`/clientesAtuntaqui/${cliente.id}/PagosMensualesAtuntaqui`}>
